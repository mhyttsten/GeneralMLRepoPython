...
PATH = "/tmp/tf_dataset_and_estimator_apis1"
...
Features: {'SepalLength': <tf.Tensor 'IteratorGetNext:2' shape=(1,) dtype=float32>, 'PetalWidth': <tf.Tensor 'IteratorGetNext:1' shape=(1,) dtype=float32>, 'PetalLength': <tf.Tensor 'IteratorGetNext:0' shape=(1,) dtype=float32>, 'SepalWidth': <tf.Tensor 'IteratorGetNext:3' shape=(1,) dtype=float32>}
INFO:tensorflow:Restoring parameters from /tmp/tf_dataset_and_estimator_apis/model.ckpt-240
