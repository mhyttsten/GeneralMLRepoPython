...
def saveToCenter(logfile, path, i, rList, jList, bufferArray, summaryLength, h_size, sess, mainQN, time_per_step):
    framesdir = path + os.sep + 'frames' + os.sep
    ...
    with open(logfile, 'a') as myfile:
        ...
        make_gif(np.ones([len(imagesS), 84, 84, 3]), path + str(i) + '.gif',
        ...
        make_gif(images, framesdir + 'image' + str(i) + '.gif', duration=len(images) * time_per_step,
        ...
        wr.writerow([i,
                     ...
                     framesdir + 'image' + str(i) + '.gif',
                     framesdir+'log' + str(i) + '.csv',
                     framesdir+'sal' + str(i) + '.gif'])
        myfile.close()
    with open(framesdir+'log' + str(i) + '.csv', 'w') as myfile:
